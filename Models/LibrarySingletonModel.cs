...
{
    public virtual decimal ModifyDiceMaxValue(LibraryDice dice, decimal amount) =>amount;
    public virtual decimal ModifyDiceMinValue(LibraryDice dice, decimal amount) =>amount;
